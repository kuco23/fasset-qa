...
agent_created = context.agent_bot.parse_agent_creation(AGENT_CREATED_RESPONSE)
...
collaterals_deposited = context.agent_bot.parse_deposit_agent_collaterals(COLLATERALS_DEPOSIT_RESPONSE)
...
agent_entered_available = context.agent_bot.parse_agent_available(AGENT_ENTERED_AVAILABLE_RESPONSE)
...
agent_transfer_to_core_vault = context.agent_bot.parse_request_transfer_to_core_vault(REQUEST_TRANSFER_TO_CORE_VAULT_RESPONSE)
